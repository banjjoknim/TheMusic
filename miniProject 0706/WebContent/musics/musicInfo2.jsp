...
<script type="text/javascript">
					...
					/* function add_shopping_cart0() {
						addShoppingCart[0].innerHTML = "shopping_cart";
						alert("카트에 추가되었습니다.");
						document.addMusic0.submit();
					} */
...
<body>
	...
	<div id="container">
		...
		<form name="addMusic0" action="addCart.jsp?no=<%=musicNo%>" method="POST">
		<div id="content1">
			...
			<div id="content1_song_info">
				...
				<button id="content1_song_info_playlist_add_shopping_cart_button"
					type="button" onclick="add_shopping_cart0();">
		...
		<div id="content2">
			...
			<table>
				<tr>
					...
					<button type="button" onclick="add_shopping_cartAll();">
				...
				<%
				sql = "select * from musics inner join users on musics.user_id = users.user_id where not musics.no = ?";
				...
				<tr>
					...
					<td>
					<form name="addMusic" action="addCart.jsp?no=69" method="POST">
						<button type="button" onclick="add_shopping_cart(<%=i+1%>);">
							<i class="material-icons" style="font-size: 40px; color: red;"><span class="addShoppingCart">add_shopping_cart</span></i>
						</button>
						</form>
					</td>
