...
<body>
	...
	<div id="container">
		...
		%>
		<h1 style="color: cornsilk;">앨범 상세정보 입력</h1>
		<%
			}
		%>
		<form action="registAlbumPro.jsp" method="POST"
			...
			<div id="content1_product">
				<table
					...
					<tr>
						...
						<td colspan="2" style="border: gray 1px solid;"><input
					...
					<tr>
						...
						<td style="border: gray 1px solid;"><input type="file"
							name="musicFile" accept="audio/*" multiple></td>
					</tr>
					<tr>
						<td colspan="2" style="border: gray 1px solid;">Title</td>
						<td colspan="2" style="border: gray 1px solid;"><input
							type="text" id="title" name="title" style="width: 200px;height: 20px;"></td>
					</tr>
					<tr>
						<td colspan="2" style="border: gray 1px solid;">Artist(NickName)</td>
						<td colspan="2" style="border: gray 1px solid;"><%=rs.getString("nickName")%>
						</td>
					</tr>
					<tr>
						<td colspan="2" style="border: gray 1px solid;">Genre</td>
						<td colspan="2" style="border: gray 1px solid; padding: 5px;"><input
							...
							for="Hiphop">Hiphop&nbsp;</label> <input type="radio"
							id="Rock/Metal" name="genre" value="Rock/Metal"> <label
							for="Rock/Metal">Rock/Metal&nbsp;</label><br> <input
							type="radio" id="R&B/Soul" name="genre" value="R&B/Soul">
							<label for="R&B/Soul">R&B/Soul&nbsp;</label> <input type="radio"
							id="Dance" name="genre" value="Dance"> <label for="Dance">Dance&nbsp;</label></td>
					</tr>
					<%
					...
					<tr>
						...
						<td colspan="2" style="border: gray 1px solid;"><input
							type="radio" id="commercial" name="commercial" value="pay"
							...
							style="height: 20px;"> <label for="notCommercial">Free</label>
						</td>
					</tr>
					<%
						} else {
					...
					%>
					<!-- <tr>
				<td style="border: gray 1px solid;">Choose Music File
				</td>
					<td style="border: gray 1px solid;"><input type="file" name="musicFile"></td>
				</tr> -->

					<tr>
						<td colspan="2" style="border: gray 1px solid;"><span
							style="font-weight: bold; font-size: 20pt;">소개</span></td>
						<td colspan="2" style="border-right: gray 1px solid;"><textarea
