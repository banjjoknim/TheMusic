...
<head>
    ...
    <title>Regist Album Result</title>
...
<body>
    ...
    <div id="container">
        ...
        <div id="content1" style="border: none;">
            ...
            <h1>앨범 업로드 완료</h1>
            <h1 style="font-size: 13pt;">앨범 업로드가 완료되었습니다.<br>상세내용은 
            <%String path = request.getContextPath()+"/users/user_info.jsp"; %>
            <a style="color: coral; text-decoration: underline;" href="<%=path%>">마이페이지</a>에서 확인하실 수 있습니다.</h1>
