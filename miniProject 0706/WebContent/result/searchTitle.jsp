            ...
            <nav>
                ...
                <ul class="nav_bar_small_menu">
                    <div class="nav_bar_search">
                    	...
                    	<option style="outline:none;" value = "title" selected>Title</option>
	...
	<div id="container">
		<div id="content1">
			...
			<% }else{
				do{%>
					<ul>
					<li><div class="img-content1 img1"><img
						...
						<div class="img-with-text">
							<a style="color:gray;"><%=rs.getString(16)%></a>
						</div>
						</li>
				</ul>
				<% }while (rs.next()); 
		...
		<div id="left_sidebar">
			<ul>
				...
				<li><input type="radio" name="result" value="Title" checked="checked" id="Title"
