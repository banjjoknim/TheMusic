    ...
    <%if(session.getAttribute("id")==null) {%>
		...
		<div id="content1" style="border: none;">
			...
			<h1 style="font-size: 13pt;">
				비로그인 상태에서는 판매자등록을 할 수 없습니다.<br>판매자 등록은
		...
		<%} else if(rs.next()) { %>
		<%  if (rs.getString("member_type").equals("normal")) { %>
        <form action="Resist_Seller2.jsp" method="GET">
            ...
            <div id="terms_of_service">
                <h1>개인정보 처리방침</h1>
                <textarea readonly>
 The Music(이하 ‘회사’)은 다음과 같은 원칙에 의하여 회원의 개인정보를 수집, 이용 및 관리하고 있고, 이와 관련하여 정보통신서비스 제공자가 준수하여야 하는 대한민국의 관계법령 및 개인정보보호 규정, 가이드라인을 준수하고 있습니다.
...
시행일자: 2020년 06월 25일
            ...
            <div id="Accept_the_terms_of_use" style="border: none;">
                
                    <h4><label for="Accept_the_terms_of_use_checkbox">상기에 기재된 본 사이트의 개인정보 처리방침을 확인하였으며 이에 동의합니다.</label></h4>
                
                <input type="checkbox" id="Accept_the_terms_of_use_checkbox" required>
            </div>
...
<div id="content1" style="border: none;">
			...
			<i class="material-icons"
				style="user-select: none; font-size: 140px; color: coral; display: block; margin: 0 auto;">assignment_ind</i>
			<h1>이미 <span style="color: coral;">판매자</span>로 등록되어 있습니다.</h1>
			<h1 style="font-size: 13pt;">
				상세내용은
				<%String userInfo = request.getContextPath()+"/users/user_info.jsp"; %>
				<a style="color: coral; text-decoration: underline;"
					href="<%=userInfo%>">마이페이지</a>에서 확인할 수 있습니다.
			</h1>
